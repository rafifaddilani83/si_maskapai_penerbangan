            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" action="{{ route('pesawat.store') }}" data-parsley-validate
                                ...
                                <div class="item form-group">
                                    <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Nama
                                        Pesawat</label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <input id="middle-name" name="nama_pesawat" class="form-control" type="text"
                                            name="middle-name">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Tanggal
                                        Pembuatan</label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <input id="middle-name" name="tanggal_pembuatan" class="form-control" type="date"
                                            name="middle-name">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Tanggal
                                        Operasional</label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <input id="middle-name" name="tanggal_operasional" class="form-control" type="date"
                                            name="middle-name">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Status
                                        Pesawat</label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <input id="middle-name" name="status" class="form-control" type="text"
                                            name="middle-name">
                                    </div>
                                </div>

                                     ...
                                     <!-- <p>Add <code>.table-bordered</code> for borders on all sides of the table and cells.</p> -->
                                      ...
                                      <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $isi->id_maskapai }}</td>
                                                <td>{{ $isi->nama }}</td>
                                                <td>{{ $isi->nilai_KriteriaKualitas }}</td>
                                                <td>{{ $isi->nilai_KriteriaFasilitas }}</td>
                                                <td>{{ $isi->nilai_KriteriaHarga }}</td>
                                                <td>{{ $isi->nilai_KriteriaPelayanan }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                          ...
                                          <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $isi->id_maskapai }}</td>
                                                    <td>{{ $isi->nama }}</td>
                                                    <td>{{ $isi->convert_kriteria_kualitas }}</td>
                                                    <td>{{ $isi->convert_kriteria_fasilitas }}</td>
                                                    <td>{{ $isi->convert_kriteria_harga }}</td>
                                                    <td>{{ $isi->convert_kriteria_pelayanan }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $isi->id_maskapai }}</td>
                                                    <td>{{ $isi->nama }}</td>
                                                    <td>{{ $isi->s_kualitas }}</td>
                                                    <td>{{ $isi->s_fasilitas }}</td>
                                                    <td>{{ $isi->s_harga }}</td>
                                                    <td>{{ $isi->s_pelayanan }}</td>
                                                    <td>{{ $isi->vektor_s }}</td>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @endphp
                                        <p>Rekomendasi Maskapai terbaik adalah {{ $kes->nama }} dengan nilai vektor sebesar {{ $kes->vektor_v }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
